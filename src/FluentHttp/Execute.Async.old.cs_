namespace FluentHttp
{
    ...
    public partial class FluentHttpRequest
    {
        ...
        public IAsyncResult BeginRequest(AsyncCallback callback, object state)
        {
            ...
            requestState.RequestBody = httpBody;

            _asyncResult.HttpRequestState = requestState;

            // if there is no body, just get the response directly
            // else we need to first write the body to the request
            if (httpBody == null)
            {
            ...
            else
            {
                ...
                request.BeginGetRequestStream(GetRequestCallback, requestState);
            }
        ...
        {
            var body = _body;
            // TODO: set the post params and other necessary stuffs.
            return body;
        }
        ...
        public void GetRequestCallback(IAsyncResult asyncResult)
        {
            ...
            try
            {
                ...
                requestState.Stream = requestStream;
            }
            catch (Exception ex)
            {
                // TODO:
